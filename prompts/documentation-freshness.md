...
Please do a comprehensive analysis using sub-agents, make any necessary changes, and let me know what areas need manual attention, as well as what images/gifs I either need to replace or add.
```
